...
export class Settings {
    ...
    get animationDuration(): number {
        return this.#game.settings.get(MODULE_NAME, SETTING.ANIMATION_DURATION) * 1000;
    }

    get afkOverlayIconPath(): string {
        return this.#game.settings.get(MODULE_NAME, SETTING.AFK_OVERLAY_ICON_PATH);
    }

    get showMirrorButtons(): boolean {
        return this.#game.settings.get(MODULE_NAME, SETTING.SHOW_MIRROR_BUTTONS_HUD);
    }
    ...
    get showAFKStatusInChat(): boolean {
        return this.#game.settings.get(MODULE_NAME, SETTING.SHOW_AFK_STATUS_IN_CHAT);
    }

    get showToggleAFKButton(): boolean {
        return this.#game.settings.get(MODULE_NAME, SETTING.SHOW_TOGGLE_AFK_HUD);
    }

    get allowSpeechBubbles(): boolean {
        return this.#game.settings.get(MODULE_NAME, SETTING.ALLOW_SPEECH_BUBBLES);
    }

    get speechBubbleFontSize(): number {
        return this.#game.settings.get(MODULE_NAME, SETTING.SPEECH_BUBBLE_FONT_SIZE);
    }
}
